...
@Component({
  selector: 'app-listarbriefing',
  templateUrl: './listarbriefing.component.html',
  styleUrls: ['./listarbriefing.component.css']
})
export class ListarBriefingComponent implements OnInit {
